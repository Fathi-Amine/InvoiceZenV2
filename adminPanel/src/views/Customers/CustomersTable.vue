            ...
            <thead>
                <tr>
                    <ThCell class="border-b-2 p-2 text-left" field="id" :sort-field="sortField"
                        :sort-direction="sortDirection" @click="sortCustomer">ID</ThCell>
                    <ThCell class="border-b-2 p-2 text-left" field="name" :sort-field="sortField"
                        :sort-direction="sortDirection" @click="sortCustomer">Name</ThCell>
                    <ThCell class="border-b-2 p-2 text-left" field="email" :sort-field="sortField"
                        :sort-direction="sortDirection" @click="sortCustomer">Email</ThCell>
                    <ThCell class="border-b-2 p-2 text-left" field="phone" :sort-field="sortField"
                    :sort-direction="sortDirection" @click="sortCustomer">Phone</ThCell>
                    <ThCell class="border-b-2 p-2 text-left" field="status" :sort-field="sortField"
                        :sort-direction="sortDirection" @click="sortCustomer">Status</ThCell>
                    <ThCell class="border-b-2 p-2 text-left" field="created_at" :sort-field="sortField"
                    :sort-direction="sortDirection" @click="sortCustomer">Created at</ThCell>
            ...
            <nav v-if="customers.total > customers.limit"
                ...
                <a v-for="(link, i) of customers.links" :key="i" :disabled="!link.url" href="#"
                    ...
                    v-html="link.label" :class="[
                        ...
                        i === 0 ? 'rounded-l-md' : '',
                        i === customers.links.length - 1 ? 'rounded-r-m' : '',
