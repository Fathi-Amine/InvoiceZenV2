<template>
    <header class="h-14 shadow bg-clr-primary flex justify-between items-center p-4">
        <button @click="emit('toggle-sidebar')"
            class="flex items-center justify-center w-8 h-8 rounded transition-colors hover:bg-black/10">
            <Bars3Icon class="w-6 " />
        </button>
        ...
        <Menu as="div" class="relative inline-block text-left">
            <div>
                <MenuButton class="flex items-center">
                    <img class="rounded-full w-8 mr-2" src="https://randomuser.me/api/portraits/men/46.jpg" alt="">
                    <small>John Does</small>
                ...
                <MenuItems
                    ...
                    <div class="px-1 py-1">
                        ...
                        <button @click="logout" :class="[
                            ...
                            <ArrowLeftOnRectangleIcon :active="active" class="mr-2 h-5 w-5y" aria-hidden="true" />
                            Logout
                        </button>
                        </MenuItem>
                    </div>
